...
describe(`Articles service object`, function() {
    ...
    context(`Given 'blogful_articles' has no data`, (db) => {
        it(`getAllArticles() resolves an empty array`, (db) => {
            return ArticlesService.getAllArticles(db)
                .then(actual => {
                    expect(actual).to.eql([])
                })
        ...
        it(`insertArticle() inserts a new article and resolves the new article with an 'id'`), (db) => {
            const newArticle = {
